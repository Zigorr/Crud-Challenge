...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <svg
        className={`
          absolute left-1 top-1 h-4 w-4 text-yellow-500 transition-opacity duration-300
      ...
      <svg
        className={`
          absolute right-1 top-1 h-4 w-4 text-blue-300 transition-opacity duration-300
